...
<form on:submit|preventDefault={signup}>
	...
	<div class="field">
		<label for="email" class="label is-size-5">Username</label>
		<input value={user.firstName + user.lastName} class="input is-size-6 is-rounded" type="text" name="username" disabled/>
	</div>
	<div class="field">
